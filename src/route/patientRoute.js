...
patientRouter.route('/updateInfo/:id')
  .patch(patientValidation.updatePatientInfo, authMiddlewareLogin, authMiddlewareRole, patientController.update)
patientRouter.route('/updateInfoMedical/:id')
  .patch(patientValidation.updatePatientInfoMedical, authMiddlewareLogin, authMiddlewareRole, patientController.update)
