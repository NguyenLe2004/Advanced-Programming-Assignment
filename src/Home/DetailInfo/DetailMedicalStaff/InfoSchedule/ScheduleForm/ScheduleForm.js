  ...
  const handleSubmit = async (event) => {
    ...
    if (form.checkValidity() === false) {
      ...
      const updateTreatProcessData = [
        ...medicalStaff.treatProcess,
        newTreatProcess
      ]
      console.log(medicalStaff.treatProcess)
      console.log(updateTreatProcessData);
      const addTreatProcess = async () => {
          axios.patch("http://localhost:3000/medicalStaff/" + medicalStaff.id, {treatProcess : updateTreatProcessData} )
          .then(response => {
